    ...
    var apiCall = "https://timothymartin76.cartodb.com/api/v2/sql?format=json&q=SELECT date_trunc('month', d_date) AS \"month\" , count(*) AS \"New_Buildings\" FROM comm_area GROUP BY 1 ORDER BY 1";
    var cartodbData = [];
